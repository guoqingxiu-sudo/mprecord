...
- 支持中文 / English / Turkce / Russkii 语言切换，首次会按浏览器语言自动选择，并会记住当前浏览器的语言设置
- 提供单独的偏好设置卡片，可集中调整语言、超简模式并重新查看首次引导
- 提供提醒设置，可请求浏览器通知权限，并支持“今天还没记录”和“需要告诉家长”两类本地提醒
- 提供提醒中心，集中显示需要告诉家长、高疼痛和最近异常记录
- 保存、导入、导出、切换模式时会显示即时提示气泡
- 额外提供上学小包清单，方便孩子在学校场景下准备物品
- 默认儿童模式隐藏预测与易孕信息，家长模式下可查看更完整内容
- 家长模式支持本地 4 位 PIN 锁
- 手动覆盖预测参数
- 可安装为 PWA，并支持基础离线缓存
